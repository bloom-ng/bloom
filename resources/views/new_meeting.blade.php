...
<section class="w-full min-h-screen flex flex-col lg:flex-row">
    <div
        class="w-full lg:w-1/2 bg-[#2B2B2B] p-6 md:p-8 lg:p-12 flex flex-col items-center justify-center lg:justify-start lg:sticky lg:top-0 lg:h-screen">
        <h2
            class="text-[#FFF7EB] text-4xl md:text-5xl lg:text-6xl font-[TomatoGrotesk-Bold] mb-4 md:mb-6 text-center lg:text-left">
            Book a meeting with us</h2>
        <p
            class="text-[#FFF7EB] text-xl md:text-2xl font-[TomatoGrotesk-Thin] mb-8 md:mb-12 lg:mb-24 text-center lg:text-left">
            We’ll get back to you with the best path for you & your business.</p>
    ...
    <div class="w-full lg:w-1/2 bg-[#FFF7EB] p-4 sm:p-6 md:p-8 lg:p-12 overflow-y-scroll">
        ...
        <form action="{{ route('onboarding.store') }}" method="POST"
            class="border border-[#2B2B2B]/70 rounded-xl p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col items-center justify-center w-full">
            @csrf
            <h2 class="text-[#2B2B2B] text-3xl sm:text-4xl font-[TomatoGrotesk-Bold] text-center">Schedule a Meeting
            </h2>
            <div class="w-full text-[#2B2B2B]/70 font-[TomatoGrotesk-Regular]">
                ...
                <input type="text" placeholder="Name" name="requester_name"
                    class="border border-[#2B2B2B]/70 rounded-lg p-4 w-full mb-4 bg-transparent placeholder:text-[#2B2B2B]/70">
                <input type="email" placeholder="Email" name="requester_email"
                    class="border border-[#2B2B2B]/70 rounded-lg p-4 w-full mb-4 bg-transparent placeholder:text-[#2B2B2B]/70">
                <input type="tel" placeholder="Phone" name="requester_phone"
                    class="border border-[#2B2B2B]/70 rounded-lg p-4 w-full mb-4 bg-transparent placeholder:text-[#2B2B2B]/70">
                ...
                <input
                    ...
                    min="{{ \Carbon\Carbon::now()->addMinutes(30)->format('Y-m-d\TH:i') }}"
                    max="{{ \Carbon\Carbon::now()->addMonths(2)->format('Y-m-d\TH:i') }}"
                ...
                <select name="meeting_with" id="meeting_with"
                    class="border border-[#2B2B2B]/70 rounded-lg p-4 w-full mb-4 bg-transparent placeholder:text-[#2B2B2B]/70">
                ...
                <textarea name="additional_info" id="additional_info"
                    class="border border-[#2B2B2B]/70 rounded-lg p-4 w-full mb-4 bg-transparent placeholder:text-[#2B2B2B]/70"></textarea>
            </div>
            <button type="submit"
                class="bg-[#FF9501] w-full text-[#FFF7EB] py-6 sm:py-8 rounded-lg text-xl sm:text-2xl md:text-3xl font-[TomatoGrotesk-Bold] hover:bg-opacity-90 transition-colors duration-200">Schedule
                Meeting</button>
        </form>
