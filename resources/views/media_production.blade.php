<x-tailwind-header-v2 title="Media Production and Product Shoot - Bloom Digital Media">
		...
		<!-- HEADER ONE -->
		<x-navbar logo="/images/images-v2/media_production_product_shoot.png"
              header="Media Production & Product Shoot"
			  width="70%"/>
		<!-- /END OF HEADER ONE -->
			...
			<div class="">
				<div class="py-4 header-text">
					<p>
						...
						Coverage | Short Films | Event Coverage | Live streaming
						of Events.
					</p>
				</div>
			</div>
