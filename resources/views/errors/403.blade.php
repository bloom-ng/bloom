<x-tailwind-header-v2 title="Error 403">
...
<div class="mx-20 my-10 h-[60vh]">
    ...
    <div>
        <div class="">
            ...
            <h6 class="text-white text-4xl">Error 403 </h6>
            <p class="text-amber-500">------- </p>

        </div>

        <div class="">
            <h1 class="text-white my-10 text-[60px]">Seems you don't have permission to perform this operation.</h1>
